...
class MeterFloodPlotBrushable_Test < MiniTest::Test
  ...
  def sqlPath
	...
	return "#{File.dirname(__FILE__)}/ExampleModel/run/6-EnergyPlus-0/eplusout.sql"
  end
  ...
  def test_MeterFloodPlot
	...
	puts "sqlPath for this run: #{sqlPath()}" 
	
    # create an instance of the measure
    measure = MeterFloodPlotBrushable.new
